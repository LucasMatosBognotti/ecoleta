...
const CreatePoint: React.FC = () => {
  ...
  const [ufs, setUfus] = useState<string[]>([]);
  ...
  useEffect(() => {
    ...
    axios.get<IBGECityesponse[]>(`https://servicodados.ibge.gov.br/api/v1/localidades/estados/${selectedUf}/municipios`).then(response => {
